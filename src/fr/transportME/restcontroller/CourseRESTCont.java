...
public class CourseRESTCont {
	...
	public ResponseEntity<Course> commanderCourse(@RequestBody Course course, BindingResult bindingResult) {
		...
		// TODO validator a creer pour verifier que l'id client passï¿½ est bien
		// existant dans la bdd sinon plantage 500
	...
	/**
	 * methode pour recuperer une course attribuee à un conducteur et non
	 * commencee
	 * 
	 * @param idConducteur
	 * @param
	...
	public ResponseEntity<List<Course>> recupererCourseAttribuee(
		...
		// conducteur sur lequel on s'est connecté
		/*
